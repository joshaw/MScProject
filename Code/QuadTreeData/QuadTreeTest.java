 ...
 * Modified: Wed 18 Jun 2014 04:42 PM
...
public class QuadTreeTest {
	public static void main(String[] args) {
		...
		main.addPoint(new Coordinate(28, 90));
		main.addPoint(new Coordinate(28, 95));
		main.addPoint(new Coordinate(28, 98));
		...
		main.addPoint(new Coordinate(76, 24));
		main.addPoint(new Coordinate(76, 23));
