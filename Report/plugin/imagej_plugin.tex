...
% TODO reword sentence too long
the Java built-in file chooser. To make the plugin more general purpose than
...
% TODO check capitalisation of quadtree QuadTree Quadtree
...
by boxes, etc.) were maintained in memory and so was slow to draw initially and
redraw with any subsequent move or resize of the window.
