...
Most implementations of the concave hull algorithm require an argement
...
Another, more complex to implement, alternative that is considered is Delaunay
...
This means that the result is a densley connected graph where every point is
