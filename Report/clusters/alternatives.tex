...
working in higher dimensions. In these cases, simple Euclidian geometry becomes
unable to cope with the computaion and so is replaced with other coordinate
systems. For simple clustering in two dimensions, however, Euclidian geometry
...
simplified to leave a sonsiderably sparser graph, keeping only the edges with
...
The GRAVIclust algorith~\cite{indulska2002gravity} works in two phases, first
