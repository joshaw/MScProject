...
% Modified: Mon 04 Aug 2014 06:06 PM
...
% TODO pseudo code comments
Line \ref{eql:a} Nodes are only propagated if they h \\
Line \ref{eql:b} Nodes are only propagated if they h \\
Line \ref{eql:c} Nodes are only propagated if they h \\
